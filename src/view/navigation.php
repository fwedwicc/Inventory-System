...
<body class="bg-gray-900">
  ...
  <!-- Navigation bar -->
  <div class="rounded-md shadow-sm border border-black border-solid grid grid-cols-5 lg:ml-64 md:ml-64 px-5 pt-5"
    role="group">
    <button type="button"
      class="inline-flex justify-center items-center py-5 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-s-lg hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-blue-500 dark:focus:text-white">
    ...
    <div class="border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 h-auto space-y-5">
      ...
      <div class="grid grid-cols-2 gap-5">
        ...
        <div class="flex items-center justify-center h-auto rounded bg-gray-50 dark:bg-gray-800 p-8 flex-col space-y-5">
          <div
            class="flex items-center justify-between p-5 w-full bg-white border border-gray-200 rounded-lg shadow border-gray-200 bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
